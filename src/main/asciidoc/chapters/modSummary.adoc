...
* If you're using an older version of VP (before 10.4), download my link:http://mjrnet.org/pinscape/downloads/NudgePlugIn.vbs.html[NudgePlugIn.vbs] script and put it in your VP Tables folder. (Don't use this version with VP 10.4 or later - use the updated version that comes with VP instead.)
