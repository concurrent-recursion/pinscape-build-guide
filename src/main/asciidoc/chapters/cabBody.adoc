...
*  xref:plywoodCuttingPlans.adoc[Plywood Cutting Plans for Cabinet Construction]
...
If you can't find or don't want to use a salvage machine, but you also don't want to build everything from scratch, there are several companies that will sell you a brand new cabinet. For options, search the web for "new pinball cabinet" or "pinball cabinet restoration". One vendor I can recommend from personal experience is link:http://mjrnet.org/pinscape/BuildGuideV2/virtuapin.com.html[VirtuaPin] . They sell cabinets in both kit form and fully assembled, and can customize them to your specifications.
...
It's just barely possible to fit a standard-width cab into a single 4' x 8' sheet, but it's much easier with two sheets. See xref:plywoodCuttingPlans.adoc[Plywood Cutting Plans for Cabinet Construction] for layout suggestions.
...
image::resources/TVDeadSpace.png[""]
...
image::resources/BackboxPartsDetails.png[""]
...
*link:https://github.com/jonaskello/wpc-cabinet/blob/master/references/williams%20widebody%20cabinet%20rev3.pdf.html[github.com/jonaskello/wpc-cabinet/blob/master/references/williams%20widebody%20cabinet%20rev3.pdf]
...
image::resources/lock-miter-join-sample.png[""]
...
image::resources/locking-rabbet-1.png[""]
...
image::resources/rabbet-join.png[""]
...
image::resources/rabbet-overhang.png[""]
...
image::resources/plain-miter-join-schematic.png[""]
...
image::resources/mitered-rabbet-dimensions.png[""]
...
image::resources/rabbet-dimensions.png[""]
...
image::resources/buttjoin-dimensions.png[""]
...
image::resources/edge-finishes.png[""]
...
image::resources/exploded-cab.png[""]
...
There are numerous ways to divide plywood sheets into the panels making up the cabinet. For some suggested layouts, see xref:plywoodCuttingPlans.adoc[Plywood Cutting Plans for Cabinet Construction] .
...
image::resources/main-left.png[""]

Left side wall, viewed from the cabinet interior side

image::resources/main-right.png[""]
...
image::resources/main-side-detail-1.png[""]

image::resources/main-side-detail-2.png[""]
...
image::resources/floor-dado.png[""]
...
image::resources/leg-bolt-cutaway.png[""]
...
*link:http://mjrnet.org/pinscape/downloads/leg-bolt-drilling-jig.zip.html[leg-bolt-drilling-jig.zip]

image::resources/leg-bolt-drill-with-guide.jpg[""]
...
image::resources/flipper-button-detail.png[""]
...
image::resources/stepped-flipper-button-drill-schematic.png[""]

Schematic diagram of the "original" flipper button drilling pattern. This is an edge-on view of the side wall.

image::resources/stepped-flipper-button-drill-view.png[""]
...
image::resources/glass-channel-profile.png[""]

image::resources/glass-channel-slot2.png[""]

image::resources/glass-channel-slot.png[""]

image::resources/glass-channel-insertion.png[""]
...
image::resources/slot-cutter-bit.jpg[""]
...
image::resources/slot-cutter-bit-in-router.jpg[""]
...
image::resources/slot-cutter-measure-1.jpg[""]

Measure the thickness of the plywood, and mark the centerpoint.

image::resources/slot-cutter-measure-2.jpg[""]
...
image::resources/slot-cutter-depth-setup.jpg[""]
...
image::resources/slot-cutter-execute.jpg[""]
...
image::resources/main-front.png[""]
...
image::resources/main-front-detail-1.png[""]

image::resources/main-front-detail-2.png[""]
...
image::resources/front-panel-slope.png[""]
...
image::resources/main-front-coin-door.png[""]
...
image::resources/coin-door-bolts.png[""]
...
image::resources/lockbar-receiver-bolts.png[""]
...
image::resources/front-panel-receiver.png[""]
...
image::resources/lockbar-into-receiver.png[""]
...
image::resources/small-pushbutton.png[""]
...
image::resources/front-panel-buttons.png[""]
...
image::resources/button-hole-drilling.png[""]
...
image::resources/front-panel-plunger.png[""]
...
image::resources/plunger-drilling.png[""]
...
image::resources/plunger-and-launch.png[""]
...
For more advice on choosing among these options, see xref:plunger.adoc[Plunger] .
...
image::resources/front-panel-inverted-plunger.png[""]
...
image::resources/main-rear-orig-vents.png[""]
...
image::resources/main-rear-joins.png[""]
...
image::resources/main-rear-rails.png[""]

image::resources/shipping-config.png[""]
...
image::resources/main-floor.png[""]
...
image::resources/rectangular-pushbutton-drill-template.png[""]

image::resources/power-button-mount.png[""]
[#softPowerButton]
...
image::resources/cashbox-fence-lock-tab.png[""]
...
image::resources/assemble-divider-0.png[""]
...
image::resources/main-shelf-fit.png[""]

*Cutting plan:*

image::resources/main-shelf.png[""]
...
image::resources/main-shelf-routing.png[""]
...
image::resources/shelf-lip-layout-1.png[""]
...
image::resources/shelf-lip-layout-2.png[""]
...
image::resources/shelf-t-nuts.png[""]

image::resources/shelf-t-nuts-2.png[""]

image::resources/shelf-t-nuts-3.png[""]
...
image::resources/backbox-wing-bolts-2.png[""]
...
image::resources/leg-bracket-spacer.png[""]

The corner braces have a triangular profile, with these dimensions:

image::resources/leg-bracket-spacer-2.png[""]

The normal way to make these is by cutting a 2x2 roughly in half, down its length, at a 45° angle. This is a bit tricky to do; for help, see xref:cornerBraceCutting.adoc[How to Make Corner Braces (and other wood prism shapes)] .
...
image::resources/leg-bracket-spacer-drilling-2.png[""]
...
image::resources/leg-bracket-spacer-drilling.png[""]
...
image::resources/exploded-backbox.png[""]

Exploded view of backbox

image::resources/backbox-joins.png[""]
...
image::resources/backbox-trim-cross-section.png[""]

For help cutting this shape, see xref:cornerBraceCutting.adoc[How to Make Corner Braces (and other wood prism shapes)] .
...
image::resources/translite-lock-plate.png[""]

image::resources/sample-t-nut.png[""]
...
image::resources/translite-lock-tnut.png[""]
...
image::resources/backbox-trim-routing.png[""]
...
image::resources/backbox-sides.png[""]
...
image::resources/backbox-sides-routing.png[""]
...
image::resources/backbox-top.png[""]

Backbox top piece (roof)


image::resources/backbox-top-slope.png[""]
...
image::resources/backbox-top-detail-1.png[""]
...
image::resources/backbox-top-detail-2.png[""]
...
image::resources/backbox-bottom.png[""]

Backbox floor


image::resources/backbox-bottom-slope.png[""]

To match the slope of the front walls, cut the front edge at a 7° angle. This is an edge-on view from the left side.

image::resources/backbox-bottom-detail-1.png[""]
...
image::resources/backbox-bottom-detail-2.png[""]

Backbox floor, bottom side, to show routing detail.

image::resources/backbox-bottom-cutouts.png[""]
...
image::resources/backbox-back.png[""]
...
image::resources/dry-fit-alignment-mark.png[""]
...
image::resources/assemble-shelf.png[""]

image::resources/assemble-shelf-2.png[""]
...
image::resources/assemble-cab-1.png[""]
...
image::resources/assemble-cab-2.png[""]

Now do the same thing with the front wall.

image::resources/assemble-cab-3.png[""]

Add the remaining side panel.

image::resources/assemble-cab-4.png[""]
...
image::resources/install-leg-bracket-orient.png[""]
...
image::resources/install-leg-bracket-1.png[""]

image::resources/install-leg-bracket-2.png[""]

image::resources/install-leg-bracket-3.png[""]
...
image::resources/install-leg-bracket-4.png[""]

image::resources/install-leg-bracket-5.png[""]

Now attach the metal leg bolt bracket. Screw in the bolts to make sure everything still fits.

image::resources/install-leg-bracket-6.png[""]
...
image::resources/install-leg-bracket-7.png[""]
...
image::resources/assemble-cab-5.png[""]
...
image::resources/install-divider-1a.png[""]

image::resources/install-divider-1b.png[""]

Place it against the floor, straight across the width of the cab.

image::resources/install-divider-1c.png[""]

Glue the triangular braces behind the fence at the corners.

image::resources/install-divider-2.png[""]
...
image::resources/install-divider-pos.png[""]

image::resources/install-divider-1.png[""]
...
image::resources/install-divider-3.png[""]
...
image::resources/assemble-cab-6.png[""]

image::resources/assemble-cab-done.png[""]
...
image::resources/assemble-backbox-1.png[""]

image::resources/assemble-backbox-2.png[""]

image::resources/assemble-backbox-3.png[""]

Attach the floor.

image::resources/assemble-backbox-4.png[""]

image::resources/assemble-backbox-5.png[""]

Add the remaining side wall.

image::resources/assemble-backbox-6.png[""]

image::resources/assemble-backbox-7.png[""]
...
image::resources/assemble-backbox-8.png[""]

image::resources/assemble-backbox-9.png[""]

image::resources/assemble-backbox-10.png[""]
...
image::resources/backbox-brace-1.png[""]
...
image::resources/backbox-brace-2.png[""]
...
image::resources/backbox-brace-3.png[""]
...
image::resources/backbox-guides-side.png[""]
