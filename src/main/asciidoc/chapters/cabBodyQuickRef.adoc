...
This is the same plan that's laid out in xref:cabBody.adoc[Cabinet Body] , but it's distilled here to just the essential checklist steps, arranged into an efficient order of execution. The order of steps makes sure that dependencies are done by the time you need them, and groups operations that use similar tool setups, as much as possible, to minimize the time you have to spend changing drill bits and so forth. The goal is that you can just go down this list while doing the woodworking and carry out the steps in order. To keep it concise, there's not much explanation here, so I've provided links at each step to the more detailed corresponding material in the main Cabinet Body chapter.
...
*  xref:lockMiterI.adoc[Lock Miter I: The Plywood-Friendly Way] - this is the join used in the original WPC cabinets
*  xref:lockMiterII.adoc[Lock Miter II: The Special Router Bit Way]
...
Reference: xref:plywoodCuttingPlans.adoc[Plywood Cutting Plans for Cabinet Construction]
...
image:resources/cab-body-plywood-layout-1-quickref.png[]]
...
link:http://mjrnet.org/pinscape/BuildGuideV2/cab-body-plywood-layout-2-quickref.png[image:resources/cab-body-plywood-layout-2-quickref.png[""]
]
...
link:http://mjrnet.org/pinscape/BuildGuideV2/cab-body-plywood-layout-3.png[image:resources/cab-body-plywood-layout-3.png[""]]
...
image::resources/back-rail-dims.png[""]
...
*  xref:cornerBraceCutting.adoc[How to Make Corner Braces (and other wood prism shapes)]
...
*  xref:lockMiterI.adoc[Lock Miter I: The Plywood-Friendly Way]
*  xref:lockMiterII.adoc[Lock Miter II: The Special Router Bit Way]
...
image::resources/main-left-floor-dado.png[""]

image::resources/main-front-floor-dado.png[""]

image::resources/main-rear-floor-dado.png[""]
...
image::resources/cashbox-fence-slot.png[""]
...
image::resources/backbox-top-translite-grooves.png[""]
...
image::resources/backbox-bottom-cable-opening.png[""]
...
image::resources/shelf-cable-opening.png[""]
...
image::resources/main-front-coin-door-cutout.png[""]
...
image::resources/pc-fan-cutouts.png[""]
...
image::resources/wpc-back-vents.png[""]
...
image::resources/floor-power-button-opening.png[""]
...
image::resources/floor-subwoofer-opening.png[""]
...
image::resources/floor-intake-fan-opening.png[""]
...
image::resources/launch-button-drills.png[""]
...
image::resources/front-panel-launch-button-only.png[""]
...
image::resources/front-panel-lockbar-and-door-bolts.png[""]
...
image::resources/side-wall-backbox-pivots.png[""]
...
image::resources/side-wall-pf-pivots.png[""]
...
image::resources/side-wall-pf-slider-pivots.png[""]
...
image::resources/backbox-bottom-hinge-bolts.png[""]
...
image::resources/backbox-floor-wing-screws.png[""]
...
image::resources/shelf-wing-screws.png[""]
...
image::resources/backbox-vents.png[""]
...
image::resources/power-inlet.png[""]
...
image::resources/main-floor-vents.png[""]

Reference: xref:cabBody.adoc#mainCabFloor[Cab Body - Floor]
...
image::resources/cashbox-fence-bracket-drills.png[""]
...
image::resources/backbox-corner-bracket-drills.png[""]
...
image::resources/backbox-insert-bracket-drills.png[""]
