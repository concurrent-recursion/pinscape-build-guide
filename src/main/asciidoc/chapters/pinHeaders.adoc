...
image::resources/schematic-pinheader-2.png[""]
...
image::resources/pinhead-installed.png[""]
...
For instructions on assembling these connectors, see xref:crimpPins.adoc[Crimp Pins] .
