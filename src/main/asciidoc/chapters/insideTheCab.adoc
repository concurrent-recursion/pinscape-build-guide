...
image::resources/inside-overview.png[""]
...
image::resources/inside-playfield.png[""]
...
image::resources/inside-shelf-lip.png[""]
...
image::resources/inside-power-strips.png[""]
...
image::resources/inside-rear-fans.png[""]
...
image::resources/inside-subwoofer-2.png[""]
...
image::resources/inside-intake-fan.png[""]
...
image::resources/inside-power-switch-1.png[""]

image::resources/inside-power-switch-2.png[""]

image::resources/inside-power-switch-3.png[""]

image::resources/inside-power-switch-4.png[""]
...
image::resources/inside-coin-door-switch-2.png[""]

image::resources/inside-coin-door-switch-3.png[""]

image::resources/inside-coin-door-switch-4.png[""]
...
image::resources/button-assembly-1.png[""]

image::resources/button-assembly-2.png[""]

image::resources/button-assembly-3.png[""]
...
image::resources/inside-front-buttons-1.png[""]

image::resources/inside-front-buttons-2.png[""]

If you're installing a Launch Ball button, it works the same way.

image::resources/inside-front-buttons-3.png[""]
...
image::resources/inside-flippers-1.png[""]

image::resources/inside-flippers-2.png[""]
...
image::resources/inside-flippers-3.png[""]
...
image::resources/inside-flippers-4.png[""]

image::resources/inside-flippers-5.png[""]

image::resources/inside-flippers-6.png[""]
...
image::resources/inside-flippers-7.png[""]
...
image::resources/inside-tilt-bob.png[""]
...
image::resources/inside-cashbox.png[""]
...
image::resources/inside-pc-1.png[""]
...
image::resources/inside-pc-2.png[""]
...
image::resources/inside-psu2-1.png[""]
...
image::resources/inside-psu2-2.png[""]
...
image::resources/inside-psu-shelf.png[""]
...
image::resources/inside-chimes.png[""]
...
image::resources/inside-chimes-2.png[""]
...
image::resources/inside-shaker.png[""]
...
image::resources/inside-gear-motor-0.png[""]
...
image::resources/inside-gear-motor-3.png[""]
...
image::resources/inside-ioctl-1.png[""]
...
image::resources/inside-ioctl-2.png[""]
...
image::resources/inside-ioctl-3.png[""]
...
image::resources/inside-ioctl-4.png[""]
...
image::resources/inside-fuses.png[""]
...
image::resources/littlefuse-155-series.png[""]
...
image::resources/SiemensContactorExample.png[""]
image::resources/StarterSolenoidExample.png[""]
image::resources/OpenFrameSolenoid-small.png[""]
...
image::resources/inside-contactors-1.png[""]
...
image::resources/inside-contactors-2.png[""]
...
image::resources/inside-contactors-3.png[""]
...
image::resources/inside-in-cab-speakers-2.png[""]
...
image::resources/inside-in-cab-speakers-1.png[""]
...
image::resources/inside-amps.png[""]
...
image::resources/inside-backbox-1.png[""]
...
image::resources/inside-backbox-2.png[""]
...
image::resources/inside-knocker.png[""]
