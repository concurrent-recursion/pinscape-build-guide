...
image::resources/flat-braided-wire.png[""]
...
image::resources/ground-prong.png[""]
...
In order for this approach to work, you'll need a setup that follows the basic plan we outlined in xref:powerSwitching.adoc[Power Switching] . Something like this:

image::resources/PowerSwitchingOverview.png[""]
...
image::resources/ground-braid-routing.png[""]
...
image::resources/ground-braid-leg-plate.png[""]
...
image::resources/ground-braid-lockbar.png[""]

image::resources/ground-braid-lockbar-2.png[""]
...
image::resources/ground-braid-coin-door.png[""]
