...
image::resources/tom-speaker-panel.png[""]
...
Around 1995, Williams switched to a different style of panel, which dispensed with the artwork to make them interchangeable among games, and which was constructed as a single molded piece of plastic to reduce assembly cost. See xref:dmdAssembly.adoc[Speaker/DMD Panel] for more about the two main types of panel, and see xref:dmdAssemblyWPC95.adoc[WPC-95 Speaker Panel] for details on the WPC-95 type in particular.
...
image::resources/dmd-panel-bracket-positions.png[""]
...
image::resources/machine-screw-flat-head-countersunk.png[""]
...
image::resources/dmd-backbox-prep-1.png[""]

image::resources/dmd-backbox-prep-2.png[""]
...
image::resources/dmd-backbox-prep-3.png[""]
...
image::resources/u-channel-holes.png[""]
...
image::resources/dmd-panel-install-1.png[""]

image::resources/dmd-panel-install-2.png[""]
...
image::resources/dmd-panel-install-3.png[""]

image::resources/dmd-panel-install-4.png[""]
...
image::resources/taf-speaker-panel.png[""]

image::resources/earthshaker-speaker-panel.png[""]
...
image::resources/pinscape-speaker-panel.png[""]
...
image::resources/speaker-panel-orig-decal.png[""]
...
image::resources/tnut-detail-1.png[""]

image::resources/tnut-detail-2.png[""]

image::resources/speaker-panel-tnuts-speakers.png[""]

image::resources/speaker-panel-tnuts-latches.png[""]

image::resources/speaker-panel-tnuts-h-channel.png[""]

When all of the T-nuts are installed, it should look something like this:

image::resources/speaker-panel-tnuts-done.png[""]
...
image::resources/spiral-fin-shank-screw.jpg[""]
...
image::resources/speaker-panel-dmd-screws.png[""]

image::resources/speaker-panel-dmd-screws-2.png[""]
...
image::resources/speaker-panel-grills.png[""]
...
image::resources/speaker-panel-h-channel-1.png[""]

image::resources/speaker-panel-h-channel-2.png[""]
...
image::resources/speaker-panel-h-channel-3.png[""]
...
image::resources/speaker-mounting.png[""]
...
image::resources/speaker-leds.png[""]
...
* The common "5050" RGB strips sold on eBay, RGB, 1cm wide, 60 LEDs per meter (the exact same type used for xref:lightStrips.adoc[undercab lighting] ). You need a length equal to the twice the circumference of your speaker openings; about 1 meter should be plenty.
* image:resources/cheap-led-strip-controller.png[""]
...
image::resources/speaker-lights-1.png[""]
...
The red and black wires coming out of the mini-controller have to be wired to 12VDC power, so you'll need to run some hookup wire into your cab where you can get to a 12V power supply. The LED connection to the mini-controllers usually use those little 4-pin LED strip connectors, which you can also find on eBay. See xref:lightStrips.adoc[Undercab Lighting] for information on the peculiar little connectors used with these light strips - since these are the same type of light strip, you should be able to cobble together the right set of connectors by consulting that section.
...
image::resources/DMD-Panel-Foam-Tape.png[""]
...
image::resources/speaker-panel-lcd-2.png[""]
...
image::resources/speaker-panel-lcd-1.png[""]
...
image::resources/speaker-panel-plan-tnuts.png[""]

All illustrations below show the front side of the panel (the side with the acrylic overlay, facing the player).

image::resources/speaker-panel-plan-orig-base-1.png[""]

image::resources/speaker-panel-plan-orig-base-2.png[""]

image::resources/speaker-panel-plan-orig-base-3.png[""]

image::resources/speaker-panel-plan-orig-base-4.png[""]

image::resources/speaker-panel-plan-orig-base-5.png[""]

image::resources/speaker-panel-plan-orig-base-6.png[""]

image::resources/speaker-panel-plan-orig-base-7.png[""]
...
image::resources/speaker-panel-plan-orig-4in-1.png[""]

image::resources/speaker-panel-plan-orig-4in-2.png[""]
...
image::resources/speaker-panel-plan-orig-5in-1.png[""]

image::resources/speaker-panel-plan-orig-5in-2.png[""]
...
image::resources/custom-speaker-placement-2.png[""]
...
image::resources/speaker-panel-orig-facing.png[""]
...
image::resources/speaker-panel-facing-wpc95.png[""]
