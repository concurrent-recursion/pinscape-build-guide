...
* image:resources/LedStripAmp.png[""]
...
image::resources/LedWizGroundWiring.png[""]
...
image::resources/LedWizBasicWiring.png[""]
...
Some older software, such as Future Pinball, accesses the LedWiz through a "DLL" file (a Windows "dynamic link library") called ledwiz.dll. You can download this from the manufacturer's Web site ( link:https://groovygamegear.com/[GroovyGameGear.com] ), but I recommend using my upgraded, open-source version instead. You can find it here: link:http://mjrnet.org/pinscape/dll-updates.html.html[DOF R3 & LEDWIZ.DLL updates] . My version works more reliably than the official DLL, because it has special logic to work around some recently discovered hardware bugs on the LedWiz itself.
...
image::resources/ledWizBoosterMOSFET.png[""]
...
image::resources/LedWizRelayBooster1.png[""]
...
image::resources/LedWizRelayBooster1Diode.png[""]
...
image::resources/LedWizRelayBooster2.png[""]
...
image::resources/SainSmartBoosterPower.png[""]
...
image::resources/SainSmartLedWizInputs.png[""]
...
image::resources/LedAmpPowerWiring.png[""]
...
image::resources/LedStripConnector.png[""]
...
image::resources/LedAmpToLedWizPorts.png[""]
...
image::resources/LedAmpDeviceWiring.png[""]
