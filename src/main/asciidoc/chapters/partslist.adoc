...
[#tcd1103PartsList]
Plunger Sensor (TSL1410R linear photo sensor array)Quantity:
...
Plunger Sensor (Potentiometer)Quantity:
...
Plunger Sensor (AEDR-8300 optical encoder)Quantity:
...
Plunger Sensor (TCD1103 linear image sensor)Quantity:
...
Plunger Calibration Button (Standalone)Quantity:
...
Plunger Calibration Button (Expansion Boards)Quantity:
...
Williams Coin Door 13-pin Connector Board - version 2Quantity:
...
Williams Coin Door 13-pin Connector Board - version 1Quantity:
