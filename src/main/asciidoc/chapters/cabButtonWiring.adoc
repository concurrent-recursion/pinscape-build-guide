...
See xref:ioControllers.adoc[I/O Controllers] for more details on the controller options.
...
image::resources/keyEncoderBasicWiring.png[""]
...
image::resources/keyEncoderDaisyChain.png[""]
...
If you're using a Pinscape Controller, you can configure how the buttons are mapped to keyboard keys or joystick buttons. Refer to xref:buttons.adoc[Pinscape Button Inputs] .
...
image::resources/ArcadeButtonWiring.png[""]
...
image::resources/microswitch.png[""]
...
image::resources/SwitchSchematic.png[""]
...
image::resources/coinDoorSmall.png[""]
