...
image::resources/diy-shaker-overview.png[""]
...
Most of the parts in this plan are ordinary hardware store items. The only exceptions are the motor itself, and the "shaft hubs". Shaft hubs are fairly easy to find online - they're used a lot in hobby robotics, mostly to attach wheels to motors. You can buy them at link:https://www.pololu.com/category/137/pololu-universal-mounting-hubs.html[Pololu] , Amazon, eBay, or Aliexpress. They currently run about $10 a pair.

Look for something like this:

image::resources/shaft-hub.png[""]
...
* Motor (12VDC, dual-shaft, 4mm to 6mm shaft, power about 20W-50W, unloaded speed 3000 to 4500 RPM; see xref:shakers.adoc#motorSourcing[Selecting a motor] in xref:shakers.adoc[Shaker motors] )
...
image::resources/diy-shaker-5.png[""]
...
image::resources/diy-shaker-6.png[""]
...
image::resources/diy-shaker-7.png[""]
...
image::resources/diy-shaker-8.png[""]
...
image::resources/ShakerMotorPositioning.png[""]
...
image::resources/diy-shaker-11.png[""]

image::resources/diy-shaker-12.png[""]
