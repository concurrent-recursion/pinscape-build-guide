...
image::resources/basic-audio-system.png[""]
...
image::resources/playfield-effects-speakers.png[""]
...
image::resources/playfield-surround-speakers.png[""]
...
image::resources/car-speaker-id.png[""]
...
image::resources/2.1-channel-wiring.png[""]
...
* Click *Configure* image:resources/configure-speakers-1.png[""]

* Select *7.1 surround* (even if you're not actually using surround speakers). Click Next.image:resources/configure-speakers-1a.png[""]

*  *Un-check* Subwoofer and Center. Check-mark Side Pair and Rear Pair if you're using playfield effects speakers, un-check them if not. Click Next.image:resources/configure-speakers-2a.png[""]

* Make sure *Front left and right* is checked for Full-range speakers image:resources/configure-speakers-2.png[""]
...
image::resources/2-plus-mono-amp-wiring.png[""]
...
image::resources/4-channel-amp-wiring.png[""]
...
*  *Check* Subwoofer, *Un-check* Center. Check-mark Side Pair and Rear Pair if you're using playfield effects speakers, un-check them if not. Click Next.image:resources/configure-speakers-3a.png[""]

*  *Un-check* Front left and right in the Full-range speakers list image:resources/configure-speakers-3.png[""]

* Click Next then click Finish
* Back in the playback device list, click on the *Properties* button image:resources/configure-speakers-4.png[""]

* Go to the *Enhancements* tab image:resources/configure-speakers-4a.png[""]
...
image::resources/playfield-effects-speakers-2.png[""]
...
image::resources/playfield-effects-wiring-1.png[""]
...
image::resources/home-theater-speaker-layout.png[""]
...
image::resources/home-theater-to-pinball-mapping.png[""]
...
* Select *7.1 surround* . Click Next.image:resources/configure-speakers-1a.png[""]

*  *Check* Side Pair and Rear Pair. *Un-check* Center. Leave Subwoofer as before, according to how you set it up for the main backbox speakers. Click Next.image:resources/configure-speakers-3c.png[""]
...
image::resources/vp-surround-setup.png[""]
...
* Turn the Windows master volume level all the way down, using the volume controls in the "system tray" at the bottom of the screen image:resources/system-tray-speaker-icon.png[""]
image::resources/volume-to-zero.png[""]
...
link:http://mjrnet.org/pinscape/PinVol.html.html[mjrnet.org/pinscape/PinVol.html]
...
image::resources/ps-volume-keys.png[""]
