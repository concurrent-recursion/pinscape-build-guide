...
image::resources/GameControllersZAxis.png[""]
...
image::resources/VP9-plunger-settings.png[""]
...
image::resources/VP10-plunger-settings.png[""]
...
image::resources/FP-plunger-settings.png[""]
...
VP tables that don't work properly with a plunger device can usually be fixed, sometimes easily and sometimes with a bit of work. That's a fairly big subject, so we cover it separately in xref:tablePlungerFixup.adoc[Fixing VP Plungers] .
