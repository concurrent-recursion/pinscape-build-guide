...
image::resources/PSUGroundInterconnects.png[""]
...
image::resources/Adafruit737.png[""]
...
image::resources/ATXSoftPowerOverride.png[""]
...
image::resources/ATXSoftPowerWireJumper.png[""]
...
These are crimp-pin housing, so it's best to use a crimping tool to assemble them. See xref:crimpPins.adoc[Crimp Pins] .
...
image::resources/ATXWithConnector.png[""]
...
The AC power cord's inner wires should consist of a black wire, a white wire, and a green wire. Connect the black wire to the power supply's "L" terminal, connect the white wire to "N", and connect the green wire to "G". The "G" terminal might instead be marked with the "ground" symbol(image:resources/GroundSymbol.png[""]
).
...
image::resources/24VPSUWiring.png[""]
...
image::resources/StepDownConverter.png[""]
...
image::resources/6V3ConverterWiring.png[""]
