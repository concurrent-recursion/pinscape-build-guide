...
image::resources/AdvancedIcon.png[""]
...
image::resources/switch-matrix.png[""]
...
image::resources/switch-matrix-2.png[""]
...
image::resources/switch-matrix-3.png[""]
...
image::resources/switch-matrix-4.png[""]
...
image::resources/lamp-matrix.png[""]
...
image::resources/lamp-matrix-2.png[""]
...
image::resources/VPinMameTest.png[""]

So let's get started. The first thing to do is fire up VPinMameTest.

NOTE: If you get an error when you run this program saying "MSSTDFMT.DLL is missing", you'll need to download that file and copy it to the same folder containing the VPinMameTest program. You can find a copy of it link:http://mjrnet.org/pinscape/downloads/msstdfmt.zip.html[here]
...
image::resources/S11OperatorButtons.png[""]
