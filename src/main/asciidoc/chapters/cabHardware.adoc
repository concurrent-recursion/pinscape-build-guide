...
image::resources/side-rail-alt-spacer.png[""]
...
image::resources/side-rail-closeup.png[""]
...
image::resources/spiral-nail.jpg[""]
...
image::resources/truss-head-screw-filed-side-view.jpg[""]
...
image::resources/truss-head-screw-filed-head.jpg[""]
...
image::resources/side-rail-tape.png[""]
...
image::resources/side-rail-positioning.png[""]
...
image::resources/install-side-rail-bolts.png[""]
...
image::resources/install-side-rails-1.png[""]
...
image::resources/install-side-rails-2.png[""]

* Remove the adhesive backing from the double-sticky tape.

image::resources/install-side-rails-3.png[""]
...
image::resources/install-side-rails-4.png[""]
...
image::resources/rear-glass-trim.png[""]
...
image::resources/rear-glass-trim-2.png[""]

image::resources/rear-glass-trim-3.png[""]
...
image::resources/install-rear-glass-trim-1.png[""]

* Slide the glass all the way back, pushing the trim flush against the back shelf

image::resources/install-rear-glass-trim-2.png[""]
...
image::resources/install-rear-glass-trim-3.png[""]

image::resources/install-rear-glass-trim-4.png[""]
...
image::resources/st-fire-button.png[""]
...
* Use my custom board:
** Grab these plans and fabricate them at link:https://oshpark.com/[OSH Park] : link:http://mjrnet.org/pinscape/downloads/Lockbar-Fire-Button-LED-plus-switch.zip.html[mjrnet.org/pinscape/downloads/Lockbar-Fire-Button-LED-plus-switch.zip]
** Switch: DTS-62K-V
...
image::resources/install-lockbar-1.png[""]
...
image::resources/install-lockbar-2.png[""]
...
image::resources/receiver-bolts.png[""]
...
image::resources/install-lockbar-3.png[""]
...
image::resources/lockbar-receiver-adjustment-screws.png[""]
...
image::resources/cashbox-nest-bracket.png[""]
...
image::resources/install-coin-door-1.png[""]
...
image::resources/install-coin-door-2.png[""]
...
image::resources/PlungerAssemblyDiagram.png[""]
...
image::resources/install-plunger.png[""]
...
image::resources/leg-leveler.png[""]
...
image::resources/attach-front-legs.png[""]
...
image::resources/attach-legs-2.png[""]
...
image::resources/attach-legs-3.png[""]
