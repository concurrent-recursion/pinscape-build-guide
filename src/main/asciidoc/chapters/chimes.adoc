...
image::resources/GottliebChimeUnit.png[""]
...
More on the acoustics of xylophone-type chimes: link:https://www.mmdigest.com/Gallery/Tech/XyloBars.html.html[www.mmdigest.com/Gallery/Tech/XyloBars.html] .
...
image::resources/FireBackboxTopper.png[""]
...
Bells and chimes are wired just like any other output device, as described in xref:feedbackWiring.adoc[Feedback Device Wiring] .
...
Always use diodes with coils. Diodes are required to protect your output controller and other electronics from interference from the magnetic field generated by a coil. See xref:diodes.adoc[Coil Diodes] .
...
*  *Shell Bell Small* and *Shell Bell Large* are for shell bells like those found in some 1960s machines (see link:http://mjrnet.org/pinscape/BuildGuideV2/shellBells.html[shell bells] above). These work exactly like chimes, but use circular metal bells rather than bars as the ringing element, for a different tonal quality.
