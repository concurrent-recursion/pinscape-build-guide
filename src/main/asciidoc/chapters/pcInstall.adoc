...
image::resources/pc-install-with-case.png[""]
...
image::resources/securing-pc-case.png[""]

* You'll need to connect wiring to the PC's soft power button so that you can turn the PC on with the cabinet's power button. (See xref:powerSwitching.adoc[Power Switching] .) I'd find the wires leading to the case power button, and splice my own extra wires onto these, running the extra wires outside the case through an available opening. You can then connect these to your cabinet power button.
...
image::resources/motherboard-placement.png[""]
...
image::resources/psu-bracket.png[""]
...
image::resources/motherboard-screws-and-spacers.png[""]
...
image::resources/motherboard-tnuts-1.png[""]

image::resources/motherboard-tnuts-2.png[""]

image::resources/motherboard-tnuts-3.png[""]

image::resources/motherboard-tnuts-4.png[""]

image::resources/motherboard-tnuts-5.png[""]
...
image::resources/improvised-vide-card-support-bracket.png[""]
...
To install: figure out where the plugs will go. I recommend the floor of the cabinet near the front. Using the wall plate insert as a template, mark the area on the floor inside the cabinet where the rectangular middle section of the plate will go.image:resources/KeystoneCuttingGuide.png[""]
