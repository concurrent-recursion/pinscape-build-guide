...
image::resources/kl25z-mma8451q.png[""]
...
image::resources/kl25z-orientation.png[""]
...
image::resources/config-tool-joystick.png[""]

That brings up the joystick viewer window:

image::resources/config-tool-joystick-viewer.png[""]
