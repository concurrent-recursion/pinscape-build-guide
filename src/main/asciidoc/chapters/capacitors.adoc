...
image::resources/disc-cap-markings.png[""]
...
image::resources/capacitor-pcb-plus-mark.png[""]
...
image::resources/polarized-cap-id-1.png[""]
...
image::resources/capacitor-pcb-install-1.png[""]

image::resources/capacitor-installed.png[""]
