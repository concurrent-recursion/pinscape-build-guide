...
For initial firmware installation, see xref:kl25zSoftwareSetup.adoc[KL25Z Software Setup] .

To configure the firmware for the expansion boards:

* Launch the Pinscape Config tool
* Click the Settings icon for your device
* Make sure the *System type* (near the top of the page) is set to *Pinscape Expansion Boards* image:resources/expansion-board-setting.png[""]
...
* A 220Ω resistor to use with the LED. (220Ω should work with any 20mA LED and a 5V supply, but you can find the exact value for your particular resistor using the calculator in xref:ledResistors.adoc[LED Resistors] .)
...
image::resources/kl25z-usb-ports.png[""]
...
image::resources/config-tool-buttons.png[""]
...
image::resources/button-inputs-cmn.png[""]
...
image::resources/small-led-test.png[""]
...
* Launch the Pinscape Config Tool
* Click the Outputs icon for the device image:resources/config-tool-outputs.png[""]
...
image::resources/flasher-test.png[""]
...
image::resources/knocker-test.png[""]
...
image::resources/main-to-power-connector.png[""]
...
image::resources/power-board-test.png[""]
...
image::resources/2nd-power-connector.png[""]
...
image::resources/main-to-chime-connector.png[""]
...
image::resources/chime-board-test.png[""]
...
image::resources/2nd-chime-connector.png[""]
