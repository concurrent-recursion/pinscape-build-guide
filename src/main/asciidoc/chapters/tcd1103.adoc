...
image::resources/tcd1103-overview-1.png[""]
...
image::resources/tcd1103_chip.png[""]

With a US quarter, for scale:

image::resources/tcd1103_chip2.png[""]
...
image::resources/tcd1103-overview.png[""]
...
link:http://mjrnet.org/pinscape/downloads/tcd1103/TCD1103_bracket.stl.html[TCD1103_bracket.stl]
...
link:http://mjrnet.org/pinscape/downloads/tcd1103/tcd1103-interface-board-smd.zip.html[tcd1103-interface-board-smd.zip]
...
image::resources/tcd1103-bracket-1.png[""]
...
image::resources/tcd1103-paper-strips-1.png[""]
...
image::resources/tcd1103-paper-strips-2.png[""]

* Tightly wrap the strip around the plunger to form a cylinder.

image::resources/tcd1103-paper-strips-3.png[""]
...
image::resources/tcd1103-paper-strips-4.png[""]
...
** Capacitor C2 *is* polarized, so its orientation does matter. The part's plastic base has an asymmetrical shape that serves as the orientation guide. Match the shape to the outline printed on the board.image:resources/tcd1103-capacitor-c2.png[""]

** The transistor's (Q1) orientation should be obvious from the pad layout
** Make sure that the sensor chip is oriented correctly: the white circle printed on the board in the corner of the corresponds to the "index" mark - a dot - printed on the *bottom* of the chip next to pin 1. Note that the index mark is printed on the bottom of the chip, so you'll have to do a little spatial reasoning to keep track of where it goes when you flip the chip over.image:resources/tcd1103-index-mark.png[""]
image:resources/tcd1103-index-mark-pcb.png[""]
...
If you're using a standalone KL25Z, I'd still recommend using the ribbon cable connector. That provides a cleaner signal path than ordinary hook-up wire would, which is important for this sensor because it uses high-speed data signals. The easiest way to connect the ribbon cable to a standalone KL25Z is using the xref:plungerBreakout.adoc[plunger sensor breakout board] :
...
image::resources/tcd1103-typical-working.png[""]
...
image::resources/tcd1103-led-soldering.png[""]
...
image::resources/tcd1103-led-resistor.png[""]
...
image::resources/tcd1103-led-mount.png[""]

== Assemble the sensor

* Fit a lock ring onto the lens, and screw it all the way to the top of (the wide part of the lens)

image::resources/tcd1103-lens-and-lock-ring-1.png[""]

image::resources/tcd1103-lens-and-lock-ring-2.png[""]

* Screw the lens into the lens mount

image::resources/tcd1103-lens-and-mount.png[""]

* Fit the sensor/lens spacer from the 3D-printed bracket over the sensor chip

image::resources/tcd1103-spacer.png[""]
...
image::resources/tcd1103-stack-1.png[""]

image::resources/tcd1103-stack-2.png[""]
...
image::resources/tcd1103-alignment.png[""]
...
image::resources/tcd1103-led-position.png[""]
...
image::resources/tcd1103-align-1.png[""]

image::resources/tcd1103-align-2.png[""]
...
image::resources/tcd1103-align-3.png[""]
...
image::resources/tcd1103-align-7.png[""]
...
image::resources/tcd1103-align-8.png[""]
...
image::resources/tcd1103-align-4.png[""]

image::resources/tcd1103-align-5.png[""]

image::resources/tcd1103-align-6.png[""]
