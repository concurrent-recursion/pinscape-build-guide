...
You can find the download link and installation instructions on the link:http://mjrnet.org/pinscape/pinvol.html.html[PinVol page] .
...
Downloads and more information are available at the link:http://mjrnet.org/pinscape/PinballY.php.html[PinballY Project Page] .
...
This is a newer program released in early 2018. It's free, but closed-source. See link:https://www.nailbuster.com/wikipinup/doku.php.html[www.nailbuster.com/wikipinup/doku.php] for download and install information.
