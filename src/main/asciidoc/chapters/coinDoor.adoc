...
image::resources/wpc-coin-door.jpg[""]
...
image::resources/suzohapp-coin-door.jpg[""]
...
* Fakes/Decals. If you only want the cosmetic effect of a coin door without any functionality, you could use a 3D-printed plastic façade, or simply a custom-printed decal with a photo of a coin door (see xref:cabArt.adoc[Cabinet Art] for more on decals). This might let you squeeze out a little cost if you're on a tight budget, or if your cab is too small for a real coin door.
...
image::resources/coin-mech.jpg[""]

image::resources/coin-mech-front.jpg[""]

image::resources/coin-mech-back.jpg[""]
...
image::resources/coin-door-mech-with-four-posts.png[""]
...
image::resources/coin-mech-install-1.jpg[""]
...
image::resources/coin-mech-install-2.png[""]
...
image::resources/coin-mech-install-3.png[""]
...
image::resources/coin-mech-orientation.png[""]
...
image::resources/coin-mech-install-4.jpg[""]
...
image::resources/coin-mech-install-4a.png[""]

image::resources/coin-mech-install-5.jpg[""]
...
image::resources/coin-mech-install-6.jpg[""]
...
image::resources/suzo-coin-mech-install-1.png[""]
...
image::resources/suzo-coin-mech-install-2.png[""]
...
image::resources/suzo-coin-mech-install-3.png[""]
...
image::resources/suzo-coin-mech-install-4.png[""]
...
image::resources/suzo-coin-mech-install-5.png[""]
...
image::resources/custom-coin-insert.jpg[""]
...
image::resources/WPCTemplate.png[""]
image::resources/SternSuzoHappTemplate.png[""]
...
image::resources/replace-coin-insert-wpc-1.png[""]
...
image::resources/replace-coin-insert-wpc-2.png[""]
...
image::resources/replace-coin-insert-wpc-3.png[""]
...
image::resources/replace-coin-insert-wpc-4.png[""]

image::resources/replace-coin-insert-wpc-5.png[""]
...
* Connect the switches and buttons to your key encoder. This includes the operator buttons, the coin chute switches, and the slam tilt switch, if present. All of these connect to the key encoder following the same pattern as other cabinet buttons, as explained in xref:cabButtonWiring.adoc[Button Wiring] .
* Connect the lamps at the top of the coin chutes to power, to make them light up when the machine is on. You can optionally connect them to your output controller to make them light up under software control; if you want to go that route, connect them just like any other feedback device, as explained in xref:feedbackWiring.adoc[Feedback Device Wiring] . In my opinion, there's no good reason to go to that kind of trouble; I'd just hard-wire them directly to power. That's exactly what the real machines do, so there's no "realism" gained from controlling these through software.
...
image::resources/WiliamsCoinDoorPlug.png[""]
...
image::resources/WilliamsCoinDoorPlugPinOut.png[""]
...
image::resources/MolexZConnector.png[""]
...
image::resources/WilliamsCoinDoorWithZAdapter.png[""]

This connector is a "crimp pin housing" type. See xref:crimpPins.adoc[Crimp Pins] for help with ordering the necessary parts assembling the connector.
...
image::resources/ScrewTerminalBlock.png[""]
...
image::resources/SternCoinDoorConnector.png[""]
...
The service buttons are just like any other cabinet buttons, so wire one terminal of each button in a daisy chain to your key encoder's Common terminal, and wire the other terminal of each button to an individual button port on the encoder. See xref:cabButtonWiring.adoc[Button Wiring] for more on the general wiring plan for buttons.
...
image::resources/CoinDoorWiring.png[""]
...
image::resources/VPAddCreditsKeyPref.png[""]
...
image::resources/PushToReject.png[""]
...
image::resources/CoinReject1.png[""]
...
image::resources/CoinReject2.png[""]
...
image::resources/CoinReject3.png[""]
...
image::resources/CoinReject4.png[""]
...
image::resources/CoinReject5.png[""]
...
image::resources/CoinReject6.png[""]
...
image::resources/CoinDoorRejectSwitchWiring.png[""]
...
image::resources/CoinRejectFreePlayWiring.png[""]
...
image::resources/extra-service-buttons.png[""]
...
image::resources/CoinDoorSwitch1.png[""]
...
image::resources/CoinDoorSwitch2.png[""]
...
image::resources/OpenCoinDoorMsg.png[""]
...
In your virtual cab, you'll wire this switch to your key encoder, just like any other button (see xref:cabButtonWiring.adoc[Button Wiring] ). This means that you can use almost any type of switch or button. Many people improvise with an ordinary microswitch, for example. My recommendation is to do it the easy way and use the same parts they use in the real machines:
...
image::resources/CoinDoorSwitchInBracket.png[""]
...
image::resources/CoinDoorSwitchTerminals.png[""]
...
image::resources/CherrySwitchLabel.png[""]
...
image::resources/CoinDoorSwitchWiring.png[""]

image::resources/QQQIcon.png[""]
...
The easiest solution is to use a real pinball cashbox, like the one pictured at right. There's a standard design for these, with slots in the lid that align with the coin chutes. See the "Cashbox" sections in xref:cabBody.adoc[Cabinet Body] and xref:cabHardware.adoc[Cabinet Hardware Installation] for more on how to install these.
