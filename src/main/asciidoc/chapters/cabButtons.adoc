...
* image:resources/start-button-small.png[""]
...
* image:resources/exit-button-small.png[""]
...
* image:resources/coin-in-button-small.png[""]
...
* image:resources/tiltbob-small.png[""]
...
*  *Launch Ball:*  _Nice to have if you have a plunger; essential if not._  image:resources/LaunchBallSmall.png[""]
...
My preference is to control the audio volume via external cabinet buttons for Volume Up and Volume Down. This is possible if you use some software to provide a keyboard interface to the Windows master line-out volume level, such as my link:http://mjrnet.org/pinscape/PinVol.html.html[PinVol] utility.
...
*  *Fire!:*  _Nice to have; essential for Stern fans._ Top center of lockdown bar. image:resources/FireButton.png[""]
...
* image:resources/ServiceButtons.png[""]
...
*  *Extra Ball/Buy-In:*  _Nice to have._ Round pushbutton, below Start. image:resources/ExtraBallButton.png[""]
...
* image:resources/slam-tilt-switch.png[""]
...
image::resources/small-pushbutton-closeup.png[""]
...
image::resources/custom-button-templates.png[""]
...
image::resources/button-disassembly-1.png[""]

image::resources/button-disassembly-2.png[""]

image::resources/button-disassembly-3.png[""]

image::resources/button-disassembly-4.png[""]
...
image::resources/button-disassembly-9.png[""]

* Fit the spring back into the button body between the prongs

image::resources/button-disassembly-10.png[""]
...
image::resources/button-disassembly-11.png[""]
...
image::resources/launch-ball-button.png[""]
...
image::resources/launch-ball-button-drill-template.png[""]
...
image::resources/large-rectangular-pushbutton-1.png[""]
...
image::resources/flipper-buttons-long-short-1.png[""]
...
image::resources/vp-switch-holders-1.png[""]

image::resources/vp-switch-holders-2.png[""]
...
image::resources/single-leaf-switch.png[""]
image::resources/double-leaf-switch.png[""]
...
image::resources/tilt-bob-location.png[""]
...
image::resources/TiltBobWiring.png[""]
...
image::resources/slam-tilt-in-coin-door.png[""]
...
image::resources/slam-tilt-with-bracket.png[""]
