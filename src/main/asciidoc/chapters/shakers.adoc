...
*  link:https://www.pinballlife.com/replacement-motor-for-stern-shaker-kits.html.html[Pinball Life - replacement motor for Stern shaker kits]
...
* Generic 775 12V/24V 50W dual-shaft motor (available on link:https://www.amazon.com/dp/B07MBB5LBQ.html[Amazon] and link:https://www.aliexpress.com/item/2251832641125340.html.html[Aliexpress] as of June 2022; note that the "775" is *not* a model number or brand, but is simply a standard designation for the motor's dimensions; many other "775" motors are available that look similar but which have very different electromechanical characteristics)
...
image::resources/ShakerWithStepDownWiring.png[""]
...
Follow the general wiring plan for any output device ( xref:feedbackWiring.adoc[Feedback Device Wiring] ). Connect one terminal of the shaker motor to the positive (+) power supply voltage (usually 12V). Connect the other terminal to an available port on your output controller.

image::resources/ShakerWiring.png[""]

A diode is required, to protect your output controller and other electronics from interference from the motor's magnetic field. See xref:diodes.adoc[Coil Diodes] . If you're using a pre-built shaker assembly, it might or might not already have a diode installed; if you don't see one, assume there isn't one and add your own.
...
If you're using the Pinscape expansion boards, you can connect the shaker directly to any MOSFET Power Board port. If you're using an LedWiz, don't connect the motor directly, as it will draw too much power for an LedWiz port; you'll need some kind of booster or amplifier circuit. See "Power limits and boosters" in xref:ledwiz.adoc[LedWiz Setup] .
...
image::resources/ShakerWiring2.png[""]
