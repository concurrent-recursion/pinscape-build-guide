...
* If you're building a cabinet from scratch, there are special router bits you can use to make certain types of corner joins for the main cabinet. My preference is type of a corner join that doesn't require special bits, as described in xref:lockMiterI.adoc[Lock Miter I: The Plywood-Friendly Way] .
