...
image::resources/IR-emitter-wiring.png[""]
...
image::resources/IR-receiver-expan.png[""]
...
image::resources/IR-emitter-schematic.png[""]
...
image::resources/IR-receiver-schematic.png[""]
...
image::resources/IR-tx-config.png[""]
...
image::resources/IR-rx-config.png[""]
...
* Under that, you'll find the *IR Command List* section: image:resources/IR-command-config.png[""]
...
* To learn the first code, click the "learn" icon (image:resources/IR-learn-icon.png[""]
...
* After you've entered a code into the first blank row, a new blank row will appear. You can continue adding more codes the same way. The "learn" button (image:resources/IR-learn-icon.png[""]) programs the code for the row that you click on, so you can go back and replace any row's code with a new code later if you want.
...
After you've programmed a code, you'll notice that there's a little TV ON icon (image:resources/IR-TVON-icon.png[""]
...
* Click the Remote Control icon in the row for the button you want to assign to an IR command image:resources/button-to-ir-1.png[""]

* Select the learned IR command code to send from the list image:resources/button-to-ir-2.png[""]
