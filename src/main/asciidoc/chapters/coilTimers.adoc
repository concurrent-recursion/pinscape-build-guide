...
image::resources/CoilTimerCircuit.png[""]
...
See xref:fuses.adoc[Fuses] for information on selecting slow-blow fuses and how to predict their timing and loading properties. That chapter includes a section on pinball coils and how to select appropriate slow-blow fuses for them.
