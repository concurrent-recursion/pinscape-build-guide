...
image::resources/dmd-panel-wpc95.png[""]
...
There's a different style used in Williams/Bally machines made before 1995, which had an MDF core and plastic facing with screen-printed graphics specific to each title. See xref:dmdAssembly.adoc[Speaker/DMD Panel] for more about the two panel types, and see xref:dmdAssemblyOriginal.adoc[Original WPC Speaker Panel] for details on fabricating, assembling, and installing the older style.
...
image::resources/speaker-panel-wpc95-bushing-button.png[""]

image::resources/speaker-panel-wpc95-bushing-button-2.png[""]

Install on the inside of each side wall (left and right) of the backbox, as shown below:

image::resources/speaker-panel-wpc95-bushings.png[""]
...
image::resources/speaker-panel-wpc95-bushings-2.png[""]

image::resources/speaker-panel-wpc95-bushings-3.png[""]
...
image::resources/speaker-panel-wpc95-install-1.png[""]

Fit the bottom edge _under_ the lower bushings.

image::resources/speaker-panel-wpc95-install-2.png[""]
...
image::resources/speaker-panel-wpc95-install-3.png[""]

image::resources/speaker-panel-wpc95-install-4.png[""]

image::resources/speaker-panel-wpc95-install-5.png[""]
...
image::resources/speaker-panel-wpc95-install-6.png[""]
...
image::resources/speaker-panel-wpc95-install-7.png[""]
...
image::resources/04-10382-7-2.png[""]

And when installed:

image::resources/speaker-panel-wpc95-speaker-bracket.png[""]
...
image::resources/wpc95-speaker-grill.png[""]
...
link:https://www.dziedzic.us/wpc_speaker_plastic_display_panel.html.html[www.dziedzic.us/wpc_speaker_plastic_display_panel.html]
