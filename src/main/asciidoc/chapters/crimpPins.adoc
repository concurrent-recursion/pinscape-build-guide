...
image::resources/crimp-pin-overview.png[""]
...
image::resources/crimp-pin-wire-1.png[""]
...
image::resources/crimp-pins-on-strip-1.png[""]
...
image::resources/crimp-tool-prep-1.png[""]

image::resources/crimp-tool-prep-2.png[""]

*Step 4: Choose the slot.* Choose the slot to use based on the size of the pin you're using.

image::resources/crimp-tool-which-slot.png[""]
...
image::resources/crimp-tool-set-pin-1.png[""]

image::resources/crimp-tool-set-pin-2.png[""]

image::resources/crimp-tool-set-pin-3.png[""]

image::resources/crimp-tool-set-pin-4.png[""]
...
image::resources/crimp-tool-set-pin-5.png[""]
...
image::resources/crimp-tool-set-pin-6.png[""]
...
image::resources/crimp-pin-done.png[""]
