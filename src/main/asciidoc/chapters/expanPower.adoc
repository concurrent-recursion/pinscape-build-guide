...
image::resources/primary-power-connection.png[""]
...
image::resources/secondary-power-connection.png[""]
...
See the xref:partslist.adoc[parts list] for the necessary connectors. There are two distinct connector types:
...
These are crimp pin housings, so you have to build them by crimping the pins onto the ends of the wires, and inserting the pins into the housings. Full instructions are in xref:crimpPins.adoc[Crimp Pins] .
...
image::resources/expan-power-primary-pin-order.png[""]

image::resources/expan-power-primary-ramp.png[""]
...
image::resources/expan-power-secondary-pin-order.png[""]

image::resources/expan-power-secondary-ramp.png[""]
...
image::resources/expan-power-atx-end-1.png[""]

The disk power connectors are the four-pin connectors that look like this:

image::resources/ATXDiskConnector.png[""]

image::resources/ATXDiskConnector2.png[""]
...
These are crimp pin housings, so they require some assembly. See xref:crimpPins.adoc[Crimp Pins] for details on how to build this kind of connector.
...
image::resources/expan-power-atx-end-2.png[""]
...
image::resources/expan-power-atx-end-3.png[""]
