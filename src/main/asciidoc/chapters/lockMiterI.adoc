...
image::resources/lock-miter-manual-example-1.jpg[""]
...
image::resources/lock-miter-manual-example-2.jpg[""]

A closeup of the grooves, with the front/back piece on the left and the side piece on the right.

image::resources/lock-miter-manual-example-3.jpg[""]
...
image::resources/lock-miter-join-manual-schematic.png[""]
...
image::resources/lock-miter-join-manual-step-1.png[""]
...
image::resources/lock-miter-manual-setup-1.png[""]

image::resources/lock-miter-manual-setup-1a.png[""]
...
image::resources/lock-miter-manual-test-1.png[""]

image::resources/lock-miter-manual-test-1a.png[""]

Once you're set up, it's time to the do the actual routing for this step. Route each *SIDE* piece, with the *INSIDE FACE* down.

image::resources/lock-miter-manual-route-1.png[""]
...
image::resources/lock-miter-join-manual-step-2.png[""]
...
image::resources/lock-miter-manual-setup-2.png[""]

image::resources/lock-miter-manual-setup-2a.png[""]
...
image::resources/lock-miter-manual-route-2.png[""]
...
image::resources/lock-miter-manual-test-2.png[""]
...
image::resources/lock-miter-manual-setup-2b.png[""]
...
image::resources/lock-miter-join-manual-step-3.png[""]
...
image::resources/lock-miter-manual-setup-3.png[""]

image::resources/lock-miter-manual-setup-3a.png[""]
...
image::resources/lock-miter-manual-route-3.png[""]
...
image::resources/lock-miter-manual-test-3.png[""]
...
image::resources/lock-miter-manual-setup-3b.png[""]

*Step 4:* Cut the 45° miter on the front pieces.

image::resources/lock-miter-join-manual-step-4.png[""]
...
image::resources/lock-miter-manual-setup-4a.png[""]
...
image::resources/lock-miter-manual-setup-4b.png[""]
...
image::resources/lock-miter-manual-setup-4c.png[""]

Now move fence back (away from the blade) by about 1/8".

image::resources/lock-miter-manual-setup-4d.png[""]
...
image::resources/lock-miter-manual-setup-4e.png[""]
...
image::resources/lock-miter-manual-setup-4f.png[""]
...
image::resources/lock-miter-manual-setup-4g.png[""]
...
image::resources/lock-miter-manual-setup-5b.png[""]

Now back the fence away from the blade by about 1/8".

image::resources/lock-miter-manual-setup-5c.png[""]
...
image::resources/lock-miter-manual-setup-5d.png[""]

Do a test cut, with the *side* piece *OUTSIDE FACE down* .

image::resources/lock-miter-manual-setup-5e.png[""]

As before, we're looking for a nice sharp corner.

image::resources/lock-miter-manual-setup-5f.png[""]
...
image::resources/lock-miter-join-manual-step-6.png[""]
...
image::resources/lock-miter-manual-route-6.png[""]
...
image::resources/lock-miter-manual-test-6.png[""]

image::resources/lock-miter-manual-test-6a.png[""]
...
image::resources/router-micro-adjuster.jpg[""]
...
image::resources/router-micro-adjuster-on-table.jpg[""]
