...
image::resources/tv-orientation-in-cab.png[""]
...
image::resources/plunger-tv-conflict.png[""]
...
image::resources/playfield-at-very-top.png[""]
...
image::resources/playfield-at-normal-depth.png[""]
...
image::resources/flat-flasher-panel.png[""]

image::resources/tilted-flasher-panel.png[""]

image::resources/vertical-flasher-panel.png[""]
...
image::resources/playfield-inset-depth.png[""]
...
image::resources/tv-with-apron.png[""]

...or to put it all at the back, like this:

image::resources/tv-at-front.png[""]

In either case, some space at the back is actually nice to have, in that it's a natural place to put a flasher panel (see xref:flashers.adoc[Flashers and Strobes] ) or an LED matrix ( xref:addressableLightStrips.adoc[Addressable Light Strips] ).
...
image::resources/lifted-playfield.png[""]
...
image::resources/real-playfield-hinge.png[""]

Here's a more schematic view:

image::resources/real-playfield-hinge-2.png[""]

Taking away the side wall of the cab for a moment, here's how this all fastens to the cab:

image::resources/real-playfield-hinge-2a.png[""]
...
image::resources/real-playfield-hinge-3.png[""]

image::resources/real-playfield-hinge-4.png[""]
...
image::resources/tv-install-measure-1.png[""]
...
image::resources/tv-platform-install-1.png[""]
[#tvFrontStops]
...
image::resources/tv-platform-install-2.png[""]
...
image::resources/tv-install-measure-2.png[""]
...
image::resources/tv-platform.png[""]
...
image::resources/tv-install-measure-3.png[""]
...
image::resources/tv-install-measure-4.png[""]

You can take the platform out, leaving behind the new rear marking.

image::resources/tv-install-measure-5.png[""]
[#tvHingePosition]
...
image::resources/tv-pivot-rule.png[""]
...
image::resources/forward-pivot-1.png[""]

image::resources/forward-pivot-2.png[""]

image::resources/forward-pivot-3.png[""]
...
image::resources/rear-pivot-1.png[""]

image::resources/rear-pivot-2.png[""]
...
image::resources/mid-pivot-1.png[""]
...
image::resources/tv-install-measure-6.png[""]
...
image::resources/tv-platform-assembly-1.png[""]

image::resources/tv-platform-assembly-2.png[""]

image::resources/tv-platform-assembly-3.png[""]
...
image::resources/tv-install-measure-9.png[""]

Mark the locations of the three holes illustrated below.

image::resources/tv-install-measure-10.png[""]
...
image::resources/tv-install-measure-17.png[""]
...
image::resources/tv-platform-assembly-4.png[""]
...
image::resources/tv-install-test-1.png[""]

image::resources/tv-install-test-2.png[""]

image::resources/tv-install-test-3.png[""]

image::resources/tv-install-test-4.png[""]
...
image::resources/tv-prop-1.png[""]

image::resources/tv-prop-2.png[""]

image::resources/tv-prop-3.png[""]
...
image::resources/tv-prop-pivot-1.png[""]

image::resources/tv-prop-pivot-2.png[""]

image::resources/tv-prop-pivot-3.png[""]

image::resources/tv-prop-pivot-4.png[""]
...
image::resources/playfield-hanger-brackets.png[""]
...
image::resources/tv-platform-apron.png[""]
...
image::resources/tv-platform-flasher.png[""]

See xref:flashers.adoc[Flashers and Strobes] for more on designing and building the flasher panel itself, including the electronics and how to connect it to the software.
...
image::resources/flasher-rotate-0.png[""]

image::resources/flasher-rotate-1.png[""]

image::resources/flasher-rotate-2.png[""]

image::resources/flasher-rotate-3.png[""]
...
image::resources/lift-and-slide-1.png[""]

image::resources/lift-and-slide-2.png[""]

image::resources/lift-and-slide-3.png[""]

image::resources/lift-and-slide-4.png[""]
...
image::resources/stern-pull-and-lift-1.png[""]

image::resources/stern-pull-and-lift-2.png[""]

image::resources/stern-pull-and-lift-3.png[""]

image::resources/stern-pull-and-lift-4.png[""]

image::resources/stern-pull-and-lift-5.png[""]

image::resources/stern-pull-and-lift-6.png[""]

image::resources/stern-pull-and-lift-7.png[""]
...
image::resources/tv-on-rails-1.png[""]

image::resources/tv-on-rails-2.png[""]
...
image::resources/RoutedTVGrooves.png[""]
