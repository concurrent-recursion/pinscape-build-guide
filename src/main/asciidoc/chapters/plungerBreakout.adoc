...
image::resources/plunger-breakout-board.png[""]
...
image::resources/plunger-breakout-hookup.png[""]
...
* Download the board design: link:http://mjrnet.org/pinscape/downloads/plunger-breakout-board.zip.html[mjrnet.org/pinscape/downloads/plunger-breakout-board.zip]
...
*Step 5: Attach crimp pins.* Attach a crimp pin to *one end* of each wire. Use the type of crimp pin that matches the wire housings you're using to connect to the KL25Z, because these pins will fit into those housings. See xref:crimpPins.adoc[Crimp Pins] for instructions on how to attach them.
