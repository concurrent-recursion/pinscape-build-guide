...
More detailed advice on selecting substitute parts can be found in the chapters on the individual component types in our electronics overview section, xref:electronics.adoc#electronics[A Crash Course in Electronics] . Start at xref:compov.adoc#compov[Field Guide to Components] and follow the links to the chapters on the various components.
