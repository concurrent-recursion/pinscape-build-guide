...
The last step takes a couple of minutes because this is where the server looks up all of the parts in its database.
After you get through all of the steps, Mouser should show you the complete BOM as a list of parts with descriptions, quantities, and prices.
