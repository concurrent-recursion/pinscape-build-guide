...
We'll try to cover all of the details: how to set up the PC software, what to buy for an output controller, how to install it, how to wire the devices to it, and how to build devices for all of the popular effects.
...
All of the controllers can coexist with one another, too, so you can mix and match them if you need different capabilities.
...
That chapter goes over the commercial and DIY options available for all of the I/O controllers.
...
All of the devices are nice to have if you can afford the cost, space, output ports, and time to set them up.
