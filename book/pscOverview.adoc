...
Regardless of which option you're going with for the Pinscape controller itself, the plunger is a separate matter with a separate parts list. The xref:partslist.adoc[electronic parts list] includes separate sections with the parts needed for each plunger sensor design.
