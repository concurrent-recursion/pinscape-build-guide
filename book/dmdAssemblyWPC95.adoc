...
As a result, if you order a complete WPC-95 speaker panel assembly with all of the goodies included, it'll probably include one large and one small retainer ring.
