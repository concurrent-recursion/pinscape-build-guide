...
All of the resistors on the Pinscape board are the same shape: little cylinders with wire leads sticking out of each end.
...
In my own schematics and boards, I prefer to keep all of the digits before the "R" and simply use regular decimal points, so I'd write 4.7R in this case.
