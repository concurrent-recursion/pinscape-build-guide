...
The Pinscape expansion boards were designed using a software package called link:https://www.autodesk.com/products/eagle/overview.html[EAGLE] , from link:https://www.autodesk.com/[Autodesk] .
...
These were geneated by EAGLE from the schematics to list all of the parts used in the schematics.
...
Most vendors will want you to combine all of the Gerber output files into a single .zip file before uploading.
...
*  link:https://www.autodesk.com/products/eagle/overview.html[Download EAGLE] .
...
* In the folder containing the .brd file, you'll find a bunch of new files with the same name as the .brd file but with different extensions, including some or all of the following: .GBL, .GPI, .GTL, .GTO, .DRI, .GBO, .GBP, .GBS, .GML, .GTP, .GTS, .TXT.
...
You should now see all of the new files grouped together at the top of the listing, all with Modified dates moments ago.
...
All of the manufacturers I've looked at have better tolerances than are required for the Pinscape boards.
