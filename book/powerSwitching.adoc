...
WARNING: As with the eBay timer board, I recommend against using this solution, because it requires taking the TV apart. If possible, use the Pinscape IR transmitter solution instead. See xref:tvon.adoc#tvon[TV ON Switch] .
