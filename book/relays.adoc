...
All of the Sainsmart boards should likewise include pre-installed diodes.
...
You can tell that all of these little sub-symbols are actually part of one physical device from the repeated reference designator: all three parts are labeled "K1".
...
All of the relays I've encountered have asymmetrical pin layouts that make it impossible to plug them in wrong.
