...
The reason? Fans are uniquely tactile.
...
The completely DIY approach is probably easier.
...
One technique mentioned on the forums was to use an air duct to to route air from a small fan through an opening in the coin door.
...
At the right side of the page, you'll also find a section labeled "Fan" that lets you set the intensity range.
