...
Assuming you're using a 12V DC fan or motor, you can power the fan from the +12V terminal (yellow wire) of your secondary ATX power supply. See xref:powerSupplies.adoc#powerSupplies[Power Supplies for Feedback] .
