...
The standard type lets you set all of the lights on the strip to the same color.
You can set them to any color, but all of the LEDs will show that same color.
...
You just want a plain amplifier, since DOF is going to do all of the color control.
...
On all of the strips I've seen, the cut points are spaced about 2 inches apart, every 3 LEDs.
