...
You'll also see the LED on the KL25Z flash a status indicator pattern. Alternating green/yellow or green/blue indicate healthy operation. See xref:statusLights.adoc#statusLights[KL25Z Status Lights] for the full list of status light patterns.
