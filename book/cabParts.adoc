...
Most cab builders opt for decals printed with custom artwork. You can create your own artwork with a computer graphics program. Decals are popular because they can make your cab look just like a real machine - done properly, they make for a very professional finish. Some people prefer a simple black paint job or natural wood finish, and some go with stenciled paint decoration for a more vintage look (like machines from the 1960s or 1970s). See xref:cabArt.adoc#cabinetArt[Cabinet Art] for ideas and resources.
[cols="1,3,1"]
|===
|Item|Description|Quantity
