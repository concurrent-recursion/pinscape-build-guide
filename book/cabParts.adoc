...
Almost all of the machine-screw fasteners in a commercial pinball machines are special vibration-resistant variations of the basic types.
...
As a result, the widebodies share all of the same hardware with the standard machines except for the main front-top metal trim piece, known as the lockdown bar, and of course the glass cover.
...
With some extra work, you can get all of these parts in other finishes, such as brass, gold, or just about any powder-coat color.
...
|If you're doing your own woodworking from scratch, I recommend using a furniture-quality hardwood plywood for all of the cabinet pieces.
...
|Plywood, ½", 4'x8' sheet
|The cabinet floor and the back wall of the backbox are typically made from 1/2" material.
...
A flat pack has all of the cabinet pieces cut to size and ready to assemble.
|1
|===
