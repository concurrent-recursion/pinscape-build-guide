...
* A strip of lights down the entire length of each side of the playfield TV, usually mounted on the side wall of the cabinet just above the TV.
...
That makes smart strips different from all of the other output devices we've looked at.
...
To determine the total power requirement, count up all of the individual LEDs across all of your strips, and multiply the total number by 60mA.
