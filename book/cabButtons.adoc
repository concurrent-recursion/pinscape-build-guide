...
If you prefer separate, physical Volume Up/Down buttons, where do they go? There's no standard location for these, but even the maximalists seem to agree that these particular buttons should be hidden.
...
See the vpforums thread link:https://www.vpforums.org/index.php?showtopic=42665.html[Coin Door Volume Control] for a way to build such a knob and mount it on the coin door.
