...
It includes all of the synthesizer music, voice cues, and other digitized effects that were played back through the speakers on the original machine.
* The "mechanical" soundtrack.
This includes all of the sound effects that _aren't_ from the original ROM - the ones that are added into the Visual Pinball simulation.
...
VP doesn't require that you provide all of these speakers.
If you only have two speakers, VP will mix all of the effects together and play them back on your two speakers.
...
All of the other emulators will just provide a single soundtrack, with all effects playing back through your main speakers.
...
*  *Basic stereo:* The simplest setup is a stereo system, with two main speakers and an optional subwoofer.
...
*  *Music speakers plus separate monophonic playfield speakers:* This is the next step up.
...
*  *Separate music speakers and playfield surround speakers:* This is the most powerful setup.
...
Speakers that are made specifically as "PC speakers" generally have their own built-in amps, meaning you meaning you can just plug them straight into the sound card.
...
All of the DIY amplifier boards are based on specific integrated circuit chips that do most of the amplifier work, so when you go shopping for these, you'll find them identified primarily by the type of IC chip they use.
...
VirtuaPin used to sell these as part of their speaker packages - they don't seem to offer them any more, but you can easily find them on Amazon and eBay.
...
If want to try the Lepai, be aware that there are a number of identical looking units sold under very slightly different names, like "Lepy" and "Lepei".
...
In our case, the wall of the cabinet serves as the surface.
