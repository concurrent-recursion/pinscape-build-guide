...
To set up your standalone Pinscape device with DOF, you of course have to install DOF on your PC first. See xref:DOF.adoc#dofSetup[DOF Setup] for instructions.
