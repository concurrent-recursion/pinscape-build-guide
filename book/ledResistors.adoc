...
But it's almost always more convenient to put it on the negative side, as shown, because it's usually easier to daisy-chain all of the positive voltage connections together.
