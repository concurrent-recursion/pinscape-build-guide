...
The SainSmart boards are most attractive if you only plan on a relatively small set of feedback devices, and all of them are mechanical.
If that describes your needs, these boards are a good option.
However, the SainSmart boards aren't the best choice if you want a decked-out cab with all of the popular toys.
...
However, I think that all of the Sainsmart boards already have diodes pre-installed, so it shouldn't be necessary to add your own there.
...
Run that program.
This will list the serial numbers for all of the similar devices in your system.
...
And second, you must repeat the <Toys> entry we added above, but this time, change the <LedWizNumber> section to *41* (make it 42 for a third unit, 43 for a fourth unit, etc), *and* change all of the *Sainsmart 1.0x* entries to *Sainsmart 2.0x* for the second unit (or 3.0x for the third unit, 4.0x for the fourth unit, etc).

If your SainSmart unit has a different number of relays (they make them with 1, 2, and 4 relays as well), go through the >Toys> text we added and delete all of the sections beyond the number of relays you have.
