...
All of these options are pretty much equivalent. 
...
The sensor chip looks the same on all of the boards, but the layout of the terminals and the other parts varies slightly.
