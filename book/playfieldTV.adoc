...
Note that this chapter is about _selecting_ the playfield TV. We'll get into the details of actually installing it later, in xref:playfieldMounting.adoc#playfieldMounting[Playfield TV Mounting] .
